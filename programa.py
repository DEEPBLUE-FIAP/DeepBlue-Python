...
def votos():
    ...
    pergunta ao usuário se deseja se inscrever para ajudar a limpar a praia vencedora.'''
    print('''
1 - Sim
2 - Não''')

    escolha_inscricao = int(input('Deseja se inscrever para ajudar a limpar a praia vencedora? '))
    match escolha_inscricao:
        case 1:
            print(f'\nVocê está inscrito na praia {lista_praias[0]["nome"]}')
        case 2:
            print('\nEntendo... Poderia nos dizer por que não deseja participar?')
        case _:
